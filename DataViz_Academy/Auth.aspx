    ...
    <div id="loginView" class="app-view active-view">
        ...
        <div style="max-width: 480px; margin: 0 auto;">
            ...
            <div class="card" id="loginCard">
                ...
                <asp:Button ID="btnLogin" runat="server" Text="Sign In" OnClientClick="localStorage.setItem('userLoggedIn', 'true'); window.location.href='Profile.aspx'; return false;" CssClass="btn btn-primary" style="width: 100%;"/>
            ...
            <%-- CREATE REGISTERED PROFILE CARD --%>
...
<button type="submit" id="regSubmitBtn" class="btn btn-primary" style="width: 100%;" onclick="toggleAuthForms(false); return false;">Commit Record</button>
